...
define('SITE_URL','http://127.0.0.1/Club/');
define('ABOUT_IMG_PATH',SITE_URL.'assets/images/about/');
define('CAROUSEL_IMG_PATH',SITE_URL.'assets/images/swiper/');
define('MEMBER_IMG_PATH',SITE_URL.'assets/images/member/');
define('CLUB_IMG_PATH',SITE_URL.'assets/images/club/');
define('EVENT_IMG_PATH',SITE_URL.'assets/images/event/');

//backend upload process needs this data
define('UPLOAD_IMAGE_PATH', $_SERVER['DOCUMENT_ROOT'].'/assets/images/');
define('ABOUT_FOLDER', 'about/');
define('CAROUSEL_FOLDER', 'swiper/');
define('MEMBER_FOLDER', 'member/');
define('CLUB_FOLDER', 'club/');
