...
if(isset($_GET['seen']))
{
    ...
    if($frm_data['seen']=='all'){
        ...
        $q = "UPDATE `helpdesk` SET `seen`=? WHERE `sr_no`=?";
...
if(isset($_GET['del']))
{
    ...
    if($frm_data['del']=='all'){
        ...
        $q = "DELETE FROM `helpdesk` WHERE `sr_no`=?";
        $values = [$frm_data['del']];
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        ...
        <table class="table table-hover border">
            ...
            <tbody>
                <?php
                  $q = "SELECT * FROM `helpdesk` ORDER BY `sr_no` DESC";
