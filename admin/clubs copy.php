            ...
            <div class="table-responsive-lg" style="height: 450px; overflow-y: scroll;">
                <table class="table table-hover border text-center">
                    ...
                    <tr class="bg-dark text-light">
                        ...
                        <th scope="col">Purpose and Vision</th>
                        <th scope="col">Key Activities</th>
                        <th scope="col">Contribution to College</th>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="purpose" rows="4" class="form-control shadow-none" required></textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Key Activities</label>
                            <textarea name="activities" rows="4" class="form-control shadow-none" required></textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Contribution to College</label>
                            <textarea name="contribution" rows="4" class="form-control shadow-none" required></textarea>
                        </div>
                    </div>
                </div>
