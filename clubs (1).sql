...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Nov 17, 2025 at 08:39 PM
...
(1, 'College Club and Events', 'qshvwdhej', 0);
...
INSERT INTO `student` (`sr_id`, `club_id`, `name`, `email`, `contactno`, `course`, `std_id`, `section`) VALUES
(3, 15, 'Miss. Sangay Pem', '08230184.sce@rub.edu.bt', 17975595, 'IT', '12345', 'A');
...
--
ALTER TABLE `student`
  ADD CONSTRAINT `student_ibfk_1` FOREIGN KEY (`club_id`) REFERENCES `rooms` (`id`);
COMMIT;
